...
@section('content')
    ...
    <form id='add-person'>
        ...
        <div class="row g-3 align-items-center">
            <div class="col-1">
                <label for="add_person" class="col-form-label">人員新增(變更)</label>
            </div>
            <div class="col-3">
                <input type="input" id="add_person" class="form-control" placeholder="輸入姓名" required>
            </div>
            <div class="col-1">
                <label for="stu_id" class="col-form-label">學號(變更)</label>
            </div>
            <div class="col-3">
                <input type="input" id="stu_id" class="form-control" placeholder="輸入學號" required>
            </div>
            <div class="col-1">
                <label for="inner_code" class="col-form-label">內碼卡號</label>
            </div>
            <div class="col-3">
                <input type="input" id="inner_code" class="form-control" placeholder="輸入內碼" required>
            </div>
            <div class="col-1">
